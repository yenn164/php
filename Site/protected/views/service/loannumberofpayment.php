<?php
$this->pageTitle=Yii::app()->name . ' - Prestamo numero de pago';
        ...
        <div class="main">
            <div class="contact">
                <div class="contact-form">
                    <h2>Calculo de cuota mensual del prestamo</h2>
                  
                    <?php $form=$this->beginWidget('CActiveForm', array(
                            'id'=>'loannumberofpayment-form',
                     ...
                     <div class="flash-success">
                            <?php echo Yii::app()->user->getFlash('loannumberofpayment'); ?>
                    </div>
