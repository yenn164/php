...
if ($model['tipo'] == 1) {
    ...
    $typePropery = 'Apartamento';
} else if ($model['tipo'] == 3) {
    $typePropery = 'Terreno';
} else {
    $typePropery = 'Local Comercial';
}
?>
                    ...
                    <section class="tabs">
                        ...
                        <div class="content">
                            <div class="content-1">
                                ...
                                <ul>
                                    <li>Precio: <?php echo $model['moneda'] == 0 ? '$' . $model['precio'] : $model['moneda'] == 1 ? 'U$S' . $model['precio'] : 'UI' . $model['precio'] ?></li>
                                    ...
                                    <li>Living: <?php if ($model['living'] == 1) {
                                            $living = 'SI';
                                        } else {
                                            $living = 'NO';
                                        }
                                        echo $living
?> </li>
                                    <li>Comedor: <?php if ($model['comedor'] == 1) {
                                            $comedor = 'SI';
                                        } else {
                                            $comedor = 'NO';
                                        } echo $comedor ?> </li>
                                    <li>Terraza: <?php if ($model['terraza'] == 1) {
                                            $terraza = 'SI';
                                        } else {
                                            $terraza = 'NO';
                                        }
...
?> </li>
                                    ...
                                    <li>Equipado: <?php if ($model['equipado'] == 1) {
                                            $equi = 'SI';
                                        } else {
                                            $equi = 'NO';
                                        }
...
?> </li>
                                    ...
                                    <li>Mejoras: <?php if ($model['mejoras'] == 1) {
                                            $mejora = 'SI';
                                        } else {
                                            $mejora = 'NO';
                                        }
                                        echo $mejora
?> </li>
                                    <li>Nivelado: <?php if ($model['nivelado'] == 1) {
                                            $nivelado = 'SI';
                                        } else {
                                            $nivelado = 'NO';
                                        }
                                        echo $nivelado
?> </li>                                                                
                                    <li>Agreste: <?php if ($model['agreste'] == 1) {
                            $agreste = 'SI';
                        } else {
                            $agreste = 'NO';
                        }
...
?> </li>                                                               
                ...
                <div class="left_sidebar">
                    ...
                    <div id="mapa" style="width: 263px;height: 261px; margin-top: 359px;">
                        <?php
...
// Create GMapInfoWindows
                        $info_window_a = new EGMapInfoWindow($model['descripcion']);
...
// Create marker
                        $marker = new EGMapMarker($model['latitud'], $model['longitud'], array('title' => 'Marker With Custom Image', 'icon' => $icon));
